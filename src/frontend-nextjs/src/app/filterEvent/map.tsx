...
import { iniciarGeolocalizacao } from "@/app/services/geolocation";
import { iniciarFeedback } from "@/app/forms/utils.form";
import { evento } from "@/app/endpoints/evento.endpoint";

function coordenadaGoogle(latlng: any) {
...
function EventMap({
    ...
    useEffect(() => {
      ...
      async function success(position: any) {
        const center : any = { lat: position.coords.latitude, lng: position.coords.longitude };
        ...
        const selecionarEvento = (latlng: any) => {
